...
public class Enemy : LivingEntity
{
    ...
    private IEnumerator AttackVolley(float[] attackPos, float attackIncre)
    {
        ...
        ////check if all bullet patterns ended
        //bool allPatternActive = false;
        //do
        //{
        //    foreach (GameObject gs in transform)
        //    {
        //        if (gs.GetComponent<BulletPattern>().patternEnd)
        //        {
        //            allPatternActive = true;
        //        }

        //    }
        //    yield return null;
        //} while (allPatternActive);
